...
var SECRET_KEY string = "AllYourBase"

func GeneratAllTokens(email string, firstname string, lastname string, user_type string, uid string) (signedToken string, signedRefreshToken string, err error) {
